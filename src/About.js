...
const About = () => {
  return (
    <StyledAboutPage>
      ...
      <Paragraph>
        Hi there! I'm DHANUSREE S, currently pursuing a B.TECH in IT and eager to dive into the IT world. I'm passionate about technology and ready to learn. I bring fresh perspectives, adaptability, and a hunger to contribute to innovative projects. Let's connect and explore opportunities together!
      </Paragraph>
      <ProjectsButton href="/projects">Projects</ProjectsButton>
